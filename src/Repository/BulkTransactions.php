...
class BulkTransactions extends RepositoryLocatableAbstract
{
    ...
    public function checkType(BulkType $bulk)
    {
        ...
        $sql = "SELECT CLIENT_TYPE, FK_ID_CLIENT, TYPE, ELEMENTS_TYPE, BULK_INFO, DEFAULT_INFO FROM BULK_TYPES
     ...
     * @throws \Exception
     */
    public function getBCInfo(OAuthClient $client)
    {
        $client->clean();
        ...
        $data = $this->db->query($sql, $params, 'Api\Entity\BlockchainInfo');
     ...
     * @throws \Exception
     */
    public function spendTransaction(OAuthClient $client)
    {
        $client->clean();
