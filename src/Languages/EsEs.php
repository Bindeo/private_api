...
class EsEs extends TranslateAbstract
{
    public function __construct()
    {
        $this->texts = [
            ...
            'sign_completed_subject'      => 'Tu documento ha sido firmado',
            'sign_completed_explain'      => 'Todos los involucrados firmaron tu documento',
            'sign_completed_button'       => 'Descarga prueba',
            'sign_completed_subject_copy' => 'Todos los involucrados firmaron el documento de %s, mantén tu copia firmada',
