...
class EnUs extends TranslateAbstract
{
    public function __construct()
    {
        $this->texts = [
            ...
            'sign_request_subject'         => '%s sent you to sign "%s"',
            ...
            'sign_viewed_subject'          => '%s viewed "%s"',
            'sign_viewed_subtitle'         => '%s viewed your document',
            'sign_viewed_explanation'      => 'At %s, %s opened and viewed you document',
            'sign_code_subject'            => 'Your verification code to sign "%s"',
            ...
            'sign_signed_subject'          => '%s signed "%s"',
            'sign_signed_subtitle'         => '%s signed your document',
            'sign_signed_explanation'      => 'At %s, %s signed your document',
